    ...
    public static function wizard()
    {
        ...
        <div class="wrap" id="epyt_wiz_wrap">
                            ...
                            try
                            {
                                ...
                                if ($chanvid)
                                {
                                    ...
                                    if ($thechannel)
                                    {
                                        ...
                                        $final_title = sanitize_text_field($chanvid->snippet->channelTitle);
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            if ($thechannel)
                            {
                                ...
                                $thechannelid = esc_attr($thechannel->id);
                                $doing_live = true;
            ...
            if (!isset($_POST['wizform_submit']) || ($form_valid === false))
            {
                ...
                <div class="wiz-accordion">
                    ...
                    <h3 class="header-go"><a href="<?php echo admin_url('admin.php?page=youtube-ep-analytics-dashboard'); ?>">Check my performance, blocked countries, deleted videos, etc. (PRO) </a></h3>
                    <div class="header-go-content"></div>
                </div>
                <a id="lnkYthealth" class="ythealth imglink" href="<?php echo self::$epbase ?>/youtube-health.aspx?prokey=<?php echo esc_attr(self::$alloptions[self::$opt_pro]) ?>" target="_blank">
                ...
                <div class="container-step-customize">
                    ...
                    <div class="wizoptionbox">
                        <div id="wizoptionboxLeft">
                            <div id="ytpreviewbox">
                                <iframe ng-src="{{iframePreviewUrl()}}" id="ifPreview" title="YouTube video player" width="430" height="242" frameborder="0" allowfullscreen=""></iframe>
                            </div>
                        </div>
                        <div id="wizoptionboxRight">
                            ...
                            <div class="optionlist">
                                ...
                                <label class="opt-autoplay">
                                    ...
                                    <span class="tip" ng-if="model.autoplay == 1">
                                        <strong>Note about autoplay:</strong> Desktop browsers like Chrome and Safari are moving towards preventing autoplay for any video. So this general feature may be deprecated by most browsers in the near future.
                                    </span>
                                </label>
                                ...
                                <label><input ng-click="relChange()" id="chkRel" <?php checked($wiz_defaults[self::$opt_rel], 1); ?> type="checkbox" name="chkRel">Show related videos after playing</label>
                                <label><input ng-click="showinfoChange()" <?php checked($wiz_defaults[self::$opt_showinfo], 1); ?> id="chkShowinfo" type="checkbox" name="chkShowinfo">Show video title on hover and before playing</label>
                                ...
                                <label><input ng-click="controlsChange()" <?php checked($wiz_defaults[self::$opt_controls], 2); ?> id="chkControls" type="checkbox" name="chkControls">Show controls (uncheck to remove controls)</label>
                            ...
                            <div ng-if="!model.theplaylistid" id="panStartStop">
        ...
        <!--                                    <pre>{{ model | json }}</pre>-->
                    ...
                    <div style="height: 500px;">
                        <iframe src="<?php echo self::$epbase ?>/dashboard/prosupport.aspx?simple=1&prokey=<?php echo esc_attr(self::$alloptions[self::$opt_pro]); ?>&domain=<?php echo site_url(); ?>" width="500" height="<?php echo (self::$alloptions[self::$opt_pro] && strlen(trim(self::$alloptions[self::$opt_pro])) > 0) ? "500" : "140"; ?>"></iframe>
                    </div>
                </div>
...
//                self::$epbase . '/wpembedcode-simple-search-' . self::$version . '.aspx?pluginversion=' . self::$version .
...
//        }
    ...
    public static function do_ogvideo()
    {
        ...
        if ($ismatch)
        {
            ...
            if (isset($linkparams['v']))
            {
                ...
                <meta property="og:video" content="https://www.youtube.com/v/<?php echo esc_attr($linkparams['v']); ?>?autohide=1&amp;version=3">
    ...
    public static function ytprefs_plugin_menu()
    {
        ...
        {
            add_menu_page('YouTube Settings', 'YouTube', 'manage_options', 'youtube-my-preferences', array(get_class(), 'ytprefs_show_options'), plugins_url('images/youtubeicon16.png', __FILE__), '10.000392854349');
            add_submenu_page('youtube-my-preferences', '', '', 'manage_options', 'youtube-my-preferences', array(get_class(), 'ytprefs_show_options'));
    ...
    public static function epstats_show_options()
    {
        ...
        <div class="wrap">
            ...
            if (self::$alloptions[self::$opt_pro] && strlen(trim(self::$alloptions[self::$opt_pro])) > 0)
            {
                ...
                echo '<p><i>Logging you in below... (You can also <a class="button-primary" target="_blank" href="' . esc_attr($dashurl) . '">click here</a> to launch your dashboard in a new tab)</i></p>';
            }
            else
            {
                //// header
            ...
            ?>
            <iframe class="shadow" src="<?php echo esc_attr($dashurl) ?>" width="1060" height="3600" scrolling="auto"/>
        </div>
        <?php
    }
    ...
    public static function custom_admin_pointers()
    {
        ...
        $new_pointer_content .= "This update adds the YouTube wizard button to the new built-in WordPress text widget, and fixes a gallery scrolling issue.";
    ...
    public static function ytprefs_show_options()
    {
        ...
        <div class="ytindent">
            ...
            <form name="form1" method="post" action="" id="ytform">
                ...
                <p>
                    <b class="orange">Even more options are available to PRO users!</b> Simply click the customize button in the wizard (that looks like this <a class="button-primary cuz">&#9658; Customize</a>) to further personalize each of your embeds without having to manually add special codes yourself. The customize button will allow you to easily override most of the above default options for that embed.
                    <br>
                    <br>
                    ...
                    if ($all[self::$opt_pro] && strlen(trim($all[self::$opt_pro])) > 9)
                    {
                        ...
                        <p>
                            ...
                            <label for="<?php echo self::$opt_gallery_hidethumbimg; ?>">
                                <b>(PRO)</b> <b class="chktitle">Hide Thumbnail Images:</b><sup class="orange">NEW</sup> 
            ...
            <iframe src="<?php echo self::$epbase ?>/dashboard/prosupport.aspx?simple=1&prokey=<?php echo esc_attr($all[self::$opt_pro]); ?>&domain=<?php echo site_url(); ?>" width="500" height="<?php echo ($all[self::$opt_pro] && strlen(trim($all[self::$opt_pro])) > 0) ? "500" : "140"; ?>"></iframe>
    ...
    public static function ytprefsscript()
    {
        ...
        if (!($loggedin && self::$alloptions[self::$opt_admin_off_scripts]))
        {
            ...
            if (!is_admin() && (self::$alloptions[self::$opt_pro] && strlen(trim(self::$alloptions[self::$opt_pro])) > 0) && self::$alloptions[self::$opt_dynload] == 1)
            {
                ...
                wp_enqueue_script('__dynload__', plugins_url('scripts/embdyn' . self::$min . '.js', __FILE__), array('__ytprefs__'));
            }
        }
    }
    ...
    public static function admin_enqueue_scripts($hook)
    {
        ...
        {
            wp_enqueue_style('__ytprefs_admin__wizard_animate', plugins_url() . '/youtube-embed-plus-pro/scripts/embdyn' . self::$min . '.css');
            wp_enqueue_style('__ytprefs_admin__wizard_ui', plugins_url() . '/youtube-embed-plus-pro/styles/jquery-ui' . self::$min . '.css');
            wp_enqueue_style('__ytprefs_admin__wizard', plugins_url() . '/youtube-embed-plus-pro/styles/ytprefs-wizard' . self::$min . '.css');
            wp_enqueue_script('__ytprefs_admin__wizard_angularjs', plugins_url('scripts/angular' . self::$min . '.js', __FILE__), array());
            wp_enqueue_script('__ytprefs_admin__wizard_script', plugins_url('scripts/ytprefs-wizard' . self::$min . '.js', __FILE__), array('jquery', 'jquery-ui-accordion', 'jquery-ui-tabs', '__ytprefs_admin__wizard_angularjs'));
        }
    }
